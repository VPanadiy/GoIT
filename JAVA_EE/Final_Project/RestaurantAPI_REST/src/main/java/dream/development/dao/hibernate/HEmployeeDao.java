...
public class HEmployeeDao implements EmployeeDao {
    ...
    public List<Employee> getNames() {
        return sessionFactory.getCurrentSession().createQuery("SELECT e.name, e.surname FROM Employee e ORDER BY e.id").list();
    }
    ...
    @Override
    @Transactional(propagation = Propagation.MANDATORY)
    public Employee getByNameAndSurname(String name, String surname) {
        Session session = sessionFactory.getCurrentSession();
